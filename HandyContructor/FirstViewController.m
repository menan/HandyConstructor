...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        ...
        serviceName = [[UILabel alloc] initWithFrame:CGRectMake(marginLeft + 5.0, 0.0, 120.0, 15.0)];
        ...
        material = [[UILabel alloc] initWithFrame:CGRectMake(marginLeft + 15.0, 20.0, 120.0, 15.0)];
        ...
        labour = [[UILabel alloc] initWithFrame:CGRectMake(marginLeft + 15.0, 37.0, 120.0, 15.0)];
        ...
        serviceName = (UILabel *)[cell.contentView viewWithTag:SERVICE_LABEL_TAG];
    }
...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        [self writeDictionaryToPlist:data];
...
{
    AddServiceListViewController *dvc = (AddServiceListViewController *) [segue.destinationViewController topViewController];
